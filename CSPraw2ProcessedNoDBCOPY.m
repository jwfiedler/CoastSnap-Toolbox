function CSPraw2ProcessedNoDBCOPY(site,user,imtype,timezone)
...
%    end
    epochtime = matlab2Epoch(time +1/24);
    ...
    year = datestr(time +1/24,'YYYY'); %Have subdirectory of years to not get too confusing
